		...
		<div style="position: absolute; top: 15px; right: 15px;">
			<ul>
				<li class="dropdown user-dropdown">
					...
					<ul class="dropdown-menu" style="left:-50px;min-width:120px;">
						...
						<li><a href="##" data-toggle="modal" data-target="#editPwdModal"><span class="glyphicon glyphicon-edit"></span> 修改密码</a></li>
