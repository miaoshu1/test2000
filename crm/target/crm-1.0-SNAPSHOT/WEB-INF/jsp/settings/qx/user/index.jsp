	...
	<script>
		jQuery(function ($) {
			...
			$("#saveBtn").click(function () {
				...
				let loginAct = $("#create-loginAct");
				let loginPwd = $("#create-loginPwd");
				let confirmPwd = $("#create-confirmPwd");
				...
				alert("OK！");
				// 作业：关于工号，为了方便填写，查询出用户表中最大的工号+1作为默认的工号
				return false;
			})
		})
	</script>
				...
				<div class="modal-body">
					...
					<form class="form-horizontal" role="form">
						...
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 300px;">
								<input type="text" datetime class="form-control" id="create-expireTime">
							</div>
						</div>
						<div class="form-group">
